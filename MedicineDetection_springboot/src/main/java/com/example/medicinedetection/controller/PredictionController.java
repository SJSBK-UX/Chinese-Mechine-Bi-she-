...
import com.example.medicinedetection.entity.ImgRecords;
import com.example.medicinedetection.mapper.ImgRecordsMapper;
...
//            System.out.println("Received response: " + response);
            ...
            if (responses == null || responses.get("status") == null) {
                return Result.error("-1", "Flask返回格式异常，请稍后重试");
            }
            ...
            return Result.error("-1", "Error: " + message);
        }
    }
