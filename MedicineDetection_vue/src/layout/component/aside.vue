<template>
	<div class="h100" v-show="!isTagsViewCurrenFull">
		...
		<div v-if="isMobileAsideOpen" class="layout-aside-mobile-mode" @click="closeLayoutAsideMobileMode"></div>
	</div>
</template>
...
const isMobileAsideOpen = computed(() => state.clientWidth <= 1000 && themeConfig.value.isCollapse);
